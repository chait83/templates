...
struct struct_<xsl:value-of select="function/Name" />{
    ...
    }struct_Var_<xsl:value-of select="function/Variable_of_structure"/>;
...
{
    struct_Var_<xsl:value-of select="function/Variable_of_structure"/>.<xsl:value-of select="function/V/O/struct_input_parameters1"/> = <xsl:value-of select="function/V/I/input"/>;
    struct_Var_<xsl:value-of select="function/Variable_of_structure"/>.<xsl:value-of select="function/V/O/struct_input_parameters1"/> = <xsl:value-of select="function/V/I/input"/>;


   return  struct_Var_<xsl:value-of select="function/Variable_of_structure"/>;
}
</xsl:template>
</xsl:stylesheet>
